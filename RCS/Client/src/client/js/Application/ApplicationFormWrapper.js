...
export default class ApplicationFormWrapper extends React.Component {
  constructor() {
    super();
          ...
          <div aria-hidden='false' role='dialog' className='slds-modal slds-fade-in-open'>
              <div className='slds-modal__container'>
                  <div className='slds-modal__header'>
                      <h4 className='slds-text-heading--medium header'>{ constants.EDIT_APPLICATION }</h4>
                  </div>
                  <div className='slds-modal__content'>
                      <ApplicationForm ref='form' application={ this.props.application } validateApplication={this.state.validateApplication} />
                  </div>
