...
export default class TechnologyFormWrapper extends React.Component {
  constructor() {
    super();
          ...
          <div aria-hidden='false' role='dialog' className='slds-modal slds-fade-in-open'>
              <div className='slds-modal__container'>
                  <div className='slds-modal__header'>
                      <h4 className='slds-text-heading--medium header'>{ constants.EDIT_TECHNOLOGY }</h4>
                  </div>
                  <div className='slds-modal__content'>
                      <TechnologyForm ref='form' technology={ this.props.technology } validateTechnology={this.state.validateTechnology} />
                  </div>
