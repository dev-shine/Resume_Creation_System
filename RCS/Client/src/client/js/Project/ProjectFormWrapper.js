          ...
          <div aria-hidden='false' role='dialog' className='slds-modal slds-fade-in-open'>
              <div className='slds-modal__container modelWidth40'>
                  ...
                  <div className='slds-modal__content'>
                      <ProjectForm ref='form' project={ this.props.project } databasesActive={ this.props.databasesActive } domainsActive={ this.props.domainsActive } operatingSystemsActive={ this.props.operatingSystemsActive } technologiesActive={ this.props.technologiesActive } validateProject={this.state.validateProject} />
                  </div>
